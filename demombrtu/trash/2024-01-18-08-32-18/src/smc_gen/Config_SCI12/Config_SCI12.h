...
void R_Config_SCI12_Serial_Receive_Enable();
void R_Config_SCI12_Serial_Tranmitter_Enable();
void R_Config_SCI12_Serial_Tranmitter_Disable();
void R_Config_SCI12_Serial_Receive_Disable();
